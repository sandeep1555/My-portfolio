...
const AboutMe = () => {
  return (
    <div  id="aboutme"  className='p-2 font-mono text-white'>
    <div   className='mx-28 mt-32 shadow-lg p-4 bg-sky-600 rounded-lg' >
        ...
        <div className='px-[120px]'>
          ...
          <ul className='mx-10 py-10 list-disc '>
            <li className=''>Proficient in ReactJS for building interactive and responsive user interfaces.</li>
